...
def main():
    ...
    view_location = glGetUniformLocation(program, "position")
    ...
    particles.add_emitters(emitter)
    ...
    while not glfw.window_should_close(window):
        ...
        sizes = np.array([particles.size for particle in particles.particles], dtype=np.float32)
        ...
        glBufferData(GL_ARRAY_BUFFER, colors,nbtypes, colors, GL_DYNAMIC_DRAW)
